          ...
          <div className="flipper">
            <div className="card-payment front">
              ...
              <div className="card-provider">
                <div className="visa c-image">
                  <img src="https://i.imgur.com/NN9t7UH.png"
                   alt="visa"/>
                </div>

                <div className="mastercard c-image">
                  <img src="https://i.imgur.com/bma7TBS.png" 
                  alt="mastercard"/>
                </div>
              </div>
              ...
              <div className="cardholder-name-wrap">
                <label for="c-name" 
                className="input-title cardholder-name">
                  Name on card*
                </label>
                <input type="text" 
                name="c-number" 
            ...
            <div className="card back">
              ...
              <div className="cvv-wrap">
                <label for="cvv-code" 
                className="input-title">CVV Code*</label>
                <input type="text" 
                className="input-field cvv-code" 
                id="cvv-code" placeholder="000" 
