...
export const Home = (props) => {
  ...
  return (
    <>
      ...
      <div className="header">
        ...
        <div className="info-header left-shadow absolute">
          <div className="p-5">
            ...
            <div className="text-white">Lorem ipsum dolor sit amet, 
            ...
            <SwiperSlide key={index} className="text-center mx-auto">
              <div className="card m-2" onClick={()=>setOpen(true)}>
                <a className="card-wave">
                  <img className="card-img pt-3" src={item.img}
                    alt="image">
                  </img>
                </a>
                ...
                <div className="card-body">
                  <div className="card-title" color="gray">{item.title}</div>
      ...
      <div>
        <h5 className="font-bold text-white p-3">Populares en Jetflix</h5>
        <Swiper 
          className="container-cards"
          breakpoints={{
            320: {
      ...
      <div>
        <h5 className="font-bold text-white p-3">Tendencias</h5>
        <Swiper 
          className="container-cards"
          breakpoints={{
            320: {
